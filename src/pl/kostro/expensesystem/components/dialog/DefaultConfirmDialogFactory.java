package pl.kostro.expensesystem.components.dialog;

import java.text.NumberFormat;
import java.util.Locale;

import pl.kostro.expensesystem.components.dialog.ConfirmDialog.Factory;
...
//    private static final double BUTTON_HEIGHT = 2.5;
    ...
    public ConfirmDialog create(final String caption, final String message,
        ...
        Label text = new Label(new String(), com.vaadin.shared.ui.label.ContentMode.HTML);
