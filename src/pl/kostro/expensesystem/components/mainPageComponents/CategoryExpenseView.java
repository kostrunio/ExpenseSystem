...
public class CategoryExpenseView extends CustomComponent {
  ...
  private static final long serialVersionUID = -2865120003019786780L;
    ...
    addNewExpense.setDayView(dayView);
		...
		Expense expense = new Expense(calendar.getTime(), "", category, expenseSheet.getDefaultUserLimit().getUser(), "");
		addNewExpense.buildAddNewExpense(expenseSheet, expense, false, calendar);
	}
			...
			valueButton.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					if (event.getButton().getData() instanceof Expense) {
						...
						addNewExpense.buildAddNewExpense(expenseSheet, expense, true, calendar);
					}
				}
			});
