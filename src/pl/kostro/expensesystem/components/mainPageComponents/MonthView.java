...
public class MonthView extends CustomComponent {
	...
	public MonthView(final RealUser loggedUser, final String year) {
		...
		MenuBar.Command monthCommand = new MenuBar.Command() {
			...
			public void menuSelected(MenuItem selectedItem) {
				...
				mainView.addComponent(monthCalendar);
				showMonth(selectedItem.getText(), year);
			}
		};
		...
		monthCalendar.setHandler(new BasicDateClickHandler() {
			...
			public void dateClick(DateClickEvent event) {
				mainView.removeAllComponents();
				mainView.addComponent(new DayView(loggedUser, event.getDate()));
			}
		});
	...
	protected void showMonth(String monthName, String year) {
		try {
