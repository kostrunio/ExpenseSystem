...
public class FindExpenseView extends CustomComponent {
   ...
   * visual editor.
   */
  public FindExpenseView(final ExpenseSheet expenseSheet) {
    ...
    fromDateField.setValue(UserSummaryService.getFirstDay(new Date()));
    toDateField.setValue(UserSummaryService.getLastDay(new Date()));
  ...
  public void refreshExpenses() {
    expenseGrid.setContainerDataSource(new BeanItemContainer<>(
