...
public class AddUserView extends CustomComponent {
   ...
   */
  public AddUserView(final ExpenseSheet expenseSheet, UserLimit ul) {
    buildMainLayout();
    ...
    saveButton.addClickListener(new Button.ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        if (userLimit == null) {
          userLimit = new UserLimit(user, new BigDecimal(limitField.getValue()));
    ...
    if (userLimit != null) {
      newUser.setValue(userLimit.getUser().getName());
  ...
  private GridLayout buildNewUserGrid() {
    ...
    newUserGrid.setSpacing(true);
    newUserGrid.setColumns(2);
    newUserGrid.setRows(2);
