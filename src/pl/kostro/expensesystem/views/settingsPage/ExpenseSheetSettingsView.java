...
public class ExpenseSheetSettingsView extends CustomComponent implements View {
  ...
  private void prepareView() {
		...
		realUserTable.setHeightByRows(5);
		realUserTable.addColumn("Nazwa", String.class);
		realUserTable.addColumn("Limit", BigDecimal.class);
		realUserTable.setEditorEnabled(true);
		realUserTable.setEditorSaveCaption("Zapisz");
		realUserTable.setEditorCancelCaption("Anuluj");
		realUserTable.setImmediate(true);
		
		userTable.setHeightByRows(5);
		userTable.addColumn("Nazwa", String.class);
		userTable.addColumn("Limit", BigDecimal.class);
		userTable.setEditorEnabled(true);
		userTable.setEditorSaveCaption("Zapisz");
    userTable.setEditorCancelCaption("Anuluj");
		userTable.setImmediate(true);
		
		for (UserLimit userLimit : expenseSheet.getUserLimitList()) {
			if (userLimit.getUser() instanceof RealUser) {
				realUserTable.addRow(userLimit.getUser().getName(), userLimit.getLimit());
			} else {
				userTable.addRow(userLimit.getUser().getName(), userLimit.getLimit());
			}
		}
...
private VerticalLayout buildRealUserLayout() {
	...
	realUserLayout.setSpacing(true);
	
	// realUserTable
	realUserTable = new Grid();
	realUserTable.setImmediate(false);
	realUserTable.setWidth("200px");
	realUserTable.setHeight("200px");
...
private VerticalLayout buildUserLayout() {
	...
	userTable.setWidth("200px");
	userTable.setHeight("200px");
