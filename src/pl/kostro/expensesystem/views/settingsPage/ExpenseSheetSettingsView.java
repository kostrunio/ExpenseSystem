...
public class ExpenseSheetSettingsView extends CustomComponent implements View {
  ...
  private void prepareView() {
    ...
    moveUpCategoryButton.addClickListener(new Button.ClickListener() {
      ...
      @Override
      public void buttonClick(ClickEvent event) {
        expenseSheet = ExpenseSheetService.moveCategoryUp(expenseSheet, (Category)moveUpCategoryButton.getData());
    ...
    moveDownCategoryButton.addClickListener(new Button.ClickListener() {
      ...
      @Override
      public void buttonClick(ClickEvent event) {
        expenseSheet = ExpenseSheetService.moveCategoryDown(expenseSheet, (Category)moveUpCategoryButton.getData());
        VaadinSession.getCurrent().setAttribute(ExpenseSheet.class, expenseSheet);
        UI.getCurrent().getNavigator().navigateTo("settings");
      }
    });
  ...
  private void filUsersGirds() {
    ...
    for (UserLimit userLimit : expenseSheet.getUserLimitList()) {
      if (userLimit.getUser() instanceof RealUser)
        realUserGrid.addRow(userLimit, userLimit.getLimit(), userLimit.getOrder());
      else
        userGrid.addRow(userLimit, userLimit.getLimit(), userLimit.getOrder());
    }
