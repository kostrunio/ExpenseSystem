...
public class ExpenseSheetSettingsView extends CustomComponent implements View {
  ...
  private void prepareView() {
    ...
    addSheetButton.addClickListener(new Button.ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        Window addSheetWindow = new Window();
        addSheetWindow.setModal(true);
        addSheetWindow.setContent(new AddNewSheet());
        addSheetWindow.setWidth("200px");
        addSheetWindow.setHeight("200px");
        addSheetWindow.center();
        getUI().addWindow(addSheetWindow);
      }
    });
  ...
  private HorizontalLayout buildUserButtonLayout() {
    ...
    deleteButton.setIcon(FontAwesome.MINUS_SQUARE);
    deleteButton.setImmediate(true);
    deleteButton.setWidth("-1px");
    deleteButton.setHeight("-1px");
    userButtonLayout.addComponent(deleteButton);
