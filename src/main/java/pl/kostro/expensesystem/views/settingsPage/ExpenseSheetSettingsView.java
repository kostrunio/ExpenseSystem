...
public class ExpenseSheetSettingsView extends CustomComponent implements ExpenseSheetSettingsChangeListener {
  ...
  private void showNewSheetWindow() {
    UI.getCurrent().addWindow(new AddSheetWindow(this));
  }
