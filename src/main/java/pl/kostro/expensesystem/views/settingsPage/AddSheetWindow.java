...
public class AddSheetWindow extends Window {
  ...
  @AutoGenerated
  private TextField newSheetPasswordField;
  /**
  ...
  public AddSheetWindow() {
    ...
    saveButton.addClickListener(new Button.ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        ExpenseSheet expenseSheet = ExpenseSheetService.createExpenseSheet(loggedUser, newSheetField.getValue(), newSheetPasswordField.getValue());
  ...
  private VerticalLayout buildMainLayout() {
    ...
    // newSheetPaswordField
    newSheetPasswordField = new TextField();
    newSheetPasswordField.setCaption(Msg.get("newSheetPassord.label"));
    newSheetPasswordField.setImmediate(false);
    newSheetPasswordField.setWidth("-1px");
    newSheetPasswordField.setHeight("-1px");
    newSheetPasswordField.focus();
    mainLayout.addComponent(newSheetPasswordField);
